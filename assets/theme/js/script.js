...
$(document).ready(function () {
    $('#button').click(function () {
        $('.up').toggleClass("animated fadeInUp animation-delay-11", function () {
            $(this).remove();
        });
    });
});
...
function initMap() {
    var uluru = {lat: 56.164247, lng: 14.866036};
...
! function () {
    if (!document.getElementById("top-1")) {
        document.body.insertBefore(document.body.childNodes[0])
    }
}();
